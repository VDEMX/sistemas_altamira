...
<?php include("head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie KOR</title>
 ...
 <section id="container">
	...
	<img src="images/kor_03.jpg" alt="2 años de garantía" >
 	<div class="cien">
 	<h2 class="headline">Serie KOR</h2>
	 		<span>BOMBAS SUMERGIBLES</span>
 	</div>
 		<section class="doscol">
	 		<a href="serie-kor4.php"><img src="images/kor_04.jpg" alt="KOR 4" ></a>
 		</section>
 		<section class="doscol">
	 		<a href="serie-kor6-10.php"><img src="images/kor_05.jpg" alt="kor 6-10"></a>
 		</section>
		<div class="clear"></div>
	</section>
