...
<title><?php echo "$sitio"?> | Serie A0.6X</title>
...
<body>
 	<section id="container">
	 	...
	 	<h2 class="headline">Serie A0.6X</h2>
	 	<section class="doscol">
	 		<img src="images/a06x_02.jpg" alt="a06x_02">
	 	</section>
	 	<section class="doscol">
	 		<img src="images/a06x_03.jpg" alt="a06x_03">
	 	</section>
	 	<img src="images/a06x_05.jpg" alt="a06x_05">
	 	<h3>Curvas de rendimiento</h3>
	 	<img src="images/a06x-curvas_02.jpg" alt="a06x-curvas_02">
	 	<img src="images/a06x-curvas_04.jpg" alt="a06x-curvas_04">
	 	<img src="images/a06x-curvas_05.jpg" alt="a06x-curvas_05">
	 	<a class="button" href="bombas-AX.php"><div class="icon icon-atras"></div>Regresar</a>
		<div class="clear"></div>
	</section>
