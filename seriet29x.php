...
<?php include("head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie T29X</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie T29X</h2>
 	</div>
 	<p class="tc"><strong>BOMBAS MULTIETAPAS VERTICALES</strong> Serie T29X <span class="azul-aqua">29 lps / 1,740 lpm / 459 gpm </span> Rango: 15 a 40 lps</p>
 	<img src="images/tx-tabla-09.gif" alt="Tabla">
 	...
 	<h2>DIMENSIONES</h2>
 	<img src="images/tx-dimensiones-04.gif" alt="Dimensiones" class="mb1em">
 	<img src="images/tx-curva-03.gif" alt="Curvas">
