...
<?php include("head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie KOR 2</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie KOR 2</h2>
 	</div>
 		<p class="tc">Gasto nominal: 2 lps / 120 lpm / 32 gpm <span class="b azul-aqua">Rango de flujo: 0.83 a 2 lps / 50 a 120 lpm / 13.2 a 31.7 gpm</span></p>
        <img src="images/kor2_02.gif" alt="Tabla">
        <img src="images/kor2_03.gif" alt="Dimensiones">
        <img src="images/kor2_04.gif" alt="Curvas">
        <img src="images/kor2_06.gif" alt="Eficiencia" class="mb1em">
