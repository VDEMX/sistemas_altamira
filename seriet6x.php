...
<?php include("head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie T6X</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie T6X</h2>
 	</div>
 	<p class="tc"><strong>BOMBAS MULTIETAPAS VERTICALES</strong> Serie T6X <span class="azul-aqua">6 lps / 360 lpm / 95.1 gpm </span> Rango: 3 a 7 lps</p>
 	<img src="images/tx-tabla-14.gif" alt="Tabla">
 	...
 	<img src="images/tx-curva-08.gif" alt="Curvas">
