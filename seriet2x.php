...
<?php include("includes/head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie T2X</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie T2X</h2>
 	</div>
 	<p class="tc"><strong>BOMBAS MULTIETAPAS VERTICALES</strong> Serie T2X <span class="azul-aqua">2 lps / 120 lpm / 31.7 gpm </span> Rango: 0.8 a 2.7 lps</p>
 	<img src="images/tx-tabla-16.gif" alt="Tabla">
 	...
 	<img src="images/tx-curva-10.gif" alt="Curvas">
