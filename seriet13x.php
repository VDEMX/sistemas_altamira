...
<?php include("head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie T13X</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie T13X</h2>
 	</div>
 	<p class="tc"><strong>BOMBAS MULTIETAPAS VERTICALES</strong> Serie T13X <span class="azul-aqua">13 lps / 780 lpm / 206 gpm </span> Rango: 7 a 19 lps</p>
 	<img src="images/tx-tabla-11.gif" alt="Tabla">
 	...
 	<h2>DIMENSIONES</h2>
 	<img src="images/tx-dimensiones-05.gif" alt="Dimensiones" class="mb1em">
 	<img src="images/tx-curva-05.gif" alt="Curvas">
