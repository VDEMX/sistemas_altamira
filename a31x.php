...
<?php include("head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie A31X</title>
...
<body>
 	<section id="container">
	 	...
	 	<h2 class="headline">Serie A31X</h2>
	 	<section class="doscol">
	 		<img src="images/a24x_03.jpg" alt="a24x_03">
	 	</section>
	 	<section class="doscol">
	 		<img src="images/a24x_05.jpg" alt="a24x_05">
	 	</section>
	 	<img src="images/A31X_03.jpg" alt="A31X_03">
	 	<h3>Curvas de rendimiento</h3>
	 	<img src="images/A31X-curvas_03.jpg" alt="A31X-curvas_03">
		<img src="images/A31X-curvas_05.jpg" alt="A31X-curvas_05">
		<img src="images/A31X-curvas_06.jpg" alt="A31X-curvas_06">
