...
<?php include("includes/head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie 68BS</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie 68BS</h2>
 	</div>
 		<p class="tc"><strong>BOMBAS SUMERGIBLES ALTAMIRA</strong> Serie 68BS <span class="azul-aqua">68 lps / 4,080 lpm / 1,077 gpm </span> Rango: 25 a 80 lps</p>
        <img src="images/bs-tabla-05.gif" alt="Tabla" class="mb1em">
		<img src="images/bs-curvas-07.gif" alt="Curvas" class="mb1em">
