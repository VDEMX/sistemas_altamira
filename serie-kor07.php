...
<?php include("includes/head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie KOR 07</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie KOR 07</h2>
 	</div>
 		<p class="tc">Gasto nominal: 0.7 lps / 42 lpm / 11 gpm <span class="b azul-aqua">Rango de flujo: 0.16 a 0.83 lps / 10 a 50 lpm / 2.6 a 13.15 gpm</span></p>
        <img src="images/kor07_02.gif" alt="Tabla">
        <img src="images/kor07_03.gif" alt="Dimensiones">
        <img src="images/kor07_04.gif" alt="Curvas">
        <img src="images/kor07_05.gif" alt="Eficiencia" class="mb1em">
