...
<?php include("includes/head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie T7.5X</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie T7.5X</h2>
 	</div>
 	<p class="tc"><strong>BOMBAS MULTIETAPAS VERTICALES</strong> Serie T7.5X <span class="azul-aqua">7.5 lps / 450 lpm / 118.8 gpm </span> Rango: 3 a 9 lps</p>
 	<img src="images/tx-tabla-13.gif" alt="Tabla">
 	...
 	<h2>DIMENSIONES</h2>
 	<img src="images/tx-dimensiones-07.gif" alt="Dimensiones" class="mb1em">
 	<img src="images/tx-curva-07.gif" alt="Curvas">
