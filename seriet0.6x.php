...
<?php include("head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie T0.6X</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie T0.6X</h2>
 	</div>
 	<p class="tc"><strong>BOMBAS MULTIETAPAS VERTICALES</strong> Serie T0.6X <span class="azul-aqua">0.6 lps / 36 lpm / 9.5 gpm </span> Rango: 0.2 a 0.8 lps</p>
 	<img src="images/tx-tabla-18.gif" alt="Tabla">
 	...
 	<h2>DIMENSIONES</h2>
 	<img src="images/tx-dimensiones-12.gif" alt="Dimensiones" class="mb1em">
 	<img src="images/tx-curva-12.gif" alt="Curvas">
