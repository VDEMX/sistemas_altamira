...
<title><?php echo "$sitio"?> | Serie A14X</title>
...
<body>
 	<section id="container">
	 	...
	 	<h2 class="headline">Serie A14X</h2>
	 	<section class="doscol">
	 		<img src="images/a14x_03.jpg" alt="a14x_03">
	 	</section>
	 	<section class="doscol">
	 		<img src="images/a14x_04.jpg" alt="a14x_04">
	 	</section>
	 	<img src="images/a14x_07.jpg" alt="a14x_07">
	 	<h3>Curvas de rendimiento</h3>
	 	<img src="images/a14x-curvas_03.jpg" alt="a14x-curvas_03">
		<img src="images/a14x-curvas_05.jpg" alt="a14x-curvas_05">
		<img src="images/a14x-curvas_06.jpg" alt="a14x-curvas_06">
