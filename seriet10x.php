...
<?php include("includes/head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie T10X</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie T10X</h2>
 	</div>
 	<p class="tc"><strong>BOMBAS MULTIETAPAS VERTICALES</strong> Serie T10X <span class="azul-aqua">10 lps / 600 lpm / 158.8 gpm </span> Rango: 5 a 13 lps</p>
 	<img src="images/tx-tabla-12.gif" alt="Tabla">
 	...
 	<h2>DIMENSIONES</h2>
 	<img src="images/tx-dimensiones-06.gif" alt="Dimensiones" class="mb1em">
 	<img src="images/tx-curva-06.gif" alt="Curvas">
