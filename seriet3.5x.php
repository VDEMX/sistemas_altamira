...
<?php include("head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie T3.5X</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie T3.5X</h2>
 	</div>
 	<p class="tc"><strong>BOMBAS MULTIETAPAS VERTICALES</strong> Serie T3.5X <span class="azul-aqua">3.5 lps / 210 lpm / 55.4 gpm </span> Rango: 1.6 a 4.3 lps</p>
 	<img src="images/tx-tabla-15.gif" alt="Tabla">
 	<p class="b">* Estos modelos se manejan en inventario, favor de consultar existencias.</p>
 	<p class="nota"><strong>Nota:</strong> Las bombas Altamira serie TX están disponibles sobre pedido en versión TXE (acero inoxidable 304).</p>
 	<h2>DIMENSIONES</h2>
 	<img src="images/tx-dimensiones-10.gif" alt="Dimensiones" class="mb1em">
 	<img src="images/tx-curva-09.gif" alt="Curvas">
