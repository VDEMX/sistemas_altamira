...
<?php include("head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie A11X</title>
...
<body>
 	...
 	<section id="ax" class="active">
	 	...
	 	<h2 class="headline">Serie A11X</h2>
	 	<section class="doscol">
	 		<img src="images/A11X_03.jpg" alt="A11X_03">
	 	</section>
	 	<section class="doscol">
	 		<img src="images/A11X_04.jpg" alt="A11X_04">
	 	</section>
	 	<img src="images/A11X_07.jpg" alt="A11X_07">
	 	<h3>Curvas de rendimiento</h3>
	 	<img src="images/A11X-curvas_03.jpg" alt="A11X-curvas_03">
		<img src="images/A11X-curvas_05.jpg" alt="A11X-curvas_05">
		<img src="images/A11X-curvas_06.jpg" alt="A11X-curvas_06">
