...
<?php include("includes/head.php"); ?>
 		<title><?php echo "$sitio"?> | Serie KOR 1.2</title>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie KOR 1.2</h2>
 	</div>
 		<p class="tc">Gasto nominal: 1.2 lps / 72 lpm / 19 gpm <span class="b azul-aqua">Rango de flujo: 0.5 a 1.33 lps / 30 a 80 lpm / 8 a 21 gpm</span></p>
        <img src="images/kor1_02.gif" alt="Tabla">
        <img src="images/kor1_03.gif" alt="Dimensiones">
        <img src="images/kor1_04.gif" alt="Curvas">
        <img src="images/kor1_05.gif" alt="Eficiencia" class="mb1em">
